...
const Usuario = () => {
    ...
    return (
        <div>
            <Navbar />
            <NavbarCaro namePlaneacion={"Usuario"} />
            <div className='containerInformation'>
                <form>
                    {/*<button1 onClick={back}  >←</button1>*/}
                    <h1>Estefanía Carrillo Torres</h1>
            ...
            <div
                ...
                <div className="offcanvas-header">
                    ...
                    <button
                        type="button" className="btn-close text-reset " data-bs-dismiss="offcanvas" aria-label="Close" style={{color:"white"}}>
                    </button>
                </div>
                <div className="offcanvas-body d-block justify-content-center vh-100 my-5" >
                    <div className="text-center ">
                        <h5>Estefanía Carrillo Torres</h5>
                        <img
